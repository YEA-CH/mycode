...
const en: LocaleType = {
  ...
  Error: {
    Unauthorized: isApp
      ? `😆 There's an issue with the conversation:
       \\ 1️⃣ If you haven't configured your model API, click [here](/#/settings) to modify settings ⚙️
       \\ 2️⃣ If you can't resolve the issue, please contact support`
      : `😆 The conversation encountered some issues, don't panic:
       \ 1️⃣ If you haven't configured your model API, click [here](/#/settings) to modify settings ⚙️
       \ 2️⃣ If you're using a private deployment version, click [here](/#/auth) to enter your access key 🔑
       \ 3️⃣ If you can't resolve the issue, please contact support
       `,
  },
  Auth: {
    Return: "Return",
