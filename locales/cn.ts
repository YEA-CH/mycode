...
const cn = {
  ...
  Error: {
    Unauthorized: isApp
      ? `😆 对话遇到了一些问题:
       \\ 1️⃣ 如果你未配置模型API，点击[这里](/#/settings)修改设置 ⚙️
       \\ 2️⃣ 如果无法解决问题，请联系工作人员`
      : `😆 对话遇到了一些问题:
       \ 1️⃣ 如果你未配置模型API，点击[这里](/#/settings)修改设置 ⚙️
       \ 2️⃣ 如果你正在使用私有部署版本，点击[这里](/#/auth)输入访问秘钥 🔑
       \ 3️⃣ 如果无法解决问题，请联系工作人员
       `,
  },
  Auth: {
    Return: "返回",
  ...
  Settings: {
    ...
    Sync: {
      ...
      Overview: (overview: any) => {
        return `${overview.chat} 次对话，${overview.message} 条消息，${overview.prompt} 条提示词，${overview.mask} 个身份`;
      },
      ImportFailed: "导入失败",
    },
    Mask: {
  ...
  Mask: {
    ...
    Page: {
      Title: "预设身份",
      SubTitle: (count: number) => `${count} 个预设身份定义`,
      Search: "搜索身份",
      Create: "新建",
    },
    Item: {
